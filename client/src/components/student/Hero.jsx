...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-50 pt-40 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
        <h1 className='md:text-[48px] text-[28px] relative font-bold text-gray-800 max-w-3xl mx-auto'>Empowering learners to reach their potential, <span style={{ color: "#4CAF50" }}>
        anytime & anywhere.
        </span>
