            ...
            {enrolledCourses.map((course,index)=>(
              <tr key={index} className="border-b border-gray-500/20">
                ...
                <td className="px-4 py-3 max-sm:text-right">
                  <button className="px-3 sm:px-5 py-1.5 py-1.5 sm:py-2 bg-logocolor1 max-sm:text-xs text-white rounded-4xl cursor-pointer" onClick={()=>navigate('/player/'+course._id)}>
